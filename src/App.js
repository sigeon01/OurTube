...
class App extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      subject: { title: "우리들의 유튜브", sub: "자유로운 유튜브 영상 공유 페이지" }, // 상단 제목에 대한 정보를 객체로 설정합니다.
      ...
      contents: [
        // 컨텐츠의 배열을 설정합니다. 각 항목은 id, title, desc, image 속성을 갖습니다.
        {
          id: 1,
          title: "입문자용 HTML 강의",
          desc: "https://www.youtube.com/watch?v=rgI930gqdaY&pp=ygULSFRNTCDsnoXrrLg%3D",
          image: htmlImg,
        },
        { id: 2, title: "유니티에 대해", desc: "https://www.youtube.com/watch?v=r70NIMyTJsw&pp=ygUOVW5pdHkzZCDsnoXrrLg%3D", image: cssImg },
      ],
    };
  }
  getReadContent() {
